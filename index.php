	...
	<div class="container">
		...
		<div class="card mx-auto" style="width: 20rem;">
		  ...
		  <div class="card-body">
		    ...
		    <form id="form_login" onsubmit="location.href = 'dashboard.php';">
			  ...
			  <button type="submit" onclick="location.href = 'dashboard.php';" class="btn btn-primary"><i class="fa fa-lock">&nbsp;</i>Login</button>
			  <span><a href="register.php">Register</a></span>
			</form>
			<br>
			<button class="btn btn-outline-primary"><span><a href="dashboard.php">Next</a></span></button>
		  </div>
